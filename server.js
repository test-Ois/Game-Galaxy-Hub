...
// ============================================================
// Custom Server — Next.js + Socket.io (Multiplayer Backend)
// ============================================================
...
const rooms = new Map();
// Map: playerId -> roomId (to clean up or track disconnects)
const playerRooms = new Map();
// Reconnect timers map: playerId -> NodeJS.Timeout
const reconnectTimers = new Map();

// Periodic cleanup of orphaned/inactive rooms (Runs every 10 minutes)
setInterval(() => {
  const now = new Date();
