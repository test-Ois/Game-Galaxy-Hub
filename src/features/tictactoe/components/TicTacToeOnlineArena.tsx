// ============================================================
// Online Gameplay Component — Real-time Multiplayer Arena (Mobile-First)
// ============================================================
...
interface TicTacToeOnlineArenaProps {
  micActive: boolean;
...
export function TicTacToeOnlineArena({
  micActive,
  isSelfSpeaking,
  isOpponentSpeaking,
  isOpponentMuted,
  ...
  // Voice state and settings values are supplied via props from the composition root
              ...
              <Badge className={cn(
                ...
                connectionStatus === "connected"
                  ...
                  : ["connecting", "checking", "new"].includes(connectionStatus)
                    ? "bg-amber-500/10 border-amber-500/35 text-amber-500 animate-pulse"
